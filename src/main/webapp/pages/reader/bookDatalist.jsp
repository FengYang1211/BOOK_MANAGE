                    ...
                    <div class="table-box">
                            ...
                            <div class="col-md-8 col-md-offset-1" style="display: flex;" v-cloak>
                                <div class="col-md-2 data">
                                    <select  class="form-control select2" name="btId" >
                                        <option value="-1">AllCategory</option>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">OverdueRent</th>
                                <th class="text-center">NumberOfGuests/NumberOfReservations</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">OrderBook</h3>
                    </div>
                                ...
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                        <button type="button" @click="borrowBook"
                                                class="btn bg-maroon">Confirm</button>
    ...
    <div>
        ...
        <div v-cloak class="modal fade" id="borrowBookSuccess" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">BookingSuccessful</h3>
                        <h4 style="text-align: center;">
                            {{borrowBookSuccess}}<br>
                            Order information is available at，<a href="<%=basePath%>pages/reader/reserveBorrowBooks.jsp">BorrowInformation->ToPickUpBooks</a> menu viewing
                        </h4>
                        <div class="row data-type">
                            <div class="col-md-12 data text-center" style="margin-top: 10px;">
                                <button style="padding: 5px 40px;letter-spacing: 3px" type="button" class="btn bg-maroon" data-dismiss="modal">Confirm</button>
                            </div>
                        </div>
                    </div>
                </div>
