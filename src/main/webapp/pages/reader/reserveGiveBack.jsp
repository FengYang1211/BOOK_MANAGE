    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a onclick="location.reload()">ReturnInfo</a>
                </li>
                <li>
            </ol>
        </section>
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">DateOfTheBookShouldBeReturned</th>
                                <th class="text-center">ActualReturnDate</th>
                    ...
                    <div class="tab-pane" id="tab-common">
                        <form id="addBookForm">
                            ...
                            <div class="row data-type">
                                ...
                                <div>
                                    <div class="col-md-2 title">OverdueDeductionOfUnitPrice</div>
                                    <div class="col-md-3 data">
                                        <div readonly required class="form-control" placeholder="是否逾期" name="overDueRentalUnit"></div>
                                    </div>
                                    <div class="col-md-2 title">TotalCost</div>
                                    <div class="col-md-5 data">
