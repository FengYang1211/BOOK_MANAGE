                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button"  @click="confirmReserves"class="btn btn-default"
                                            title="确认借书"><i class="fa fa-check"></i> ConfirmBorrow</button>
                        ...
                        <form id="searchForm">
                            <div class="col-md-6 form-group" style="display: flex;" v-cloak>
                                ...
                                <div class="col-md-2 data" style="display: flex;">
                                    <input type="number" name="rbbId" autocomplete="off" required class="form-control" @keydown="verifyNum($event)" placeholder="ID" >
                                </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">BorrowingDays</th>
