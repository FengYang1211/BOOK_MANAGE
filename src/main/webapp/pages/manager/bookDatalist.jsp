                    ...
                    <div class="table-box">
                            ...
                            <div class="col-md-8 col-md-offset-1" style="display: flex;" v-cloak>
                                <div class="col-md-2 data">
                                    <select  class="form-control select2" name="btId" >
                                        <option value="-1">AllCategories</option>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">OverdueRent/day</th>
                                <th class="text-center ">Total/NumberOfLibraries</th>
                                <th class="text-center ">NumberOfReservations</th>
                            ...
                            <tr v-if="showData" v-for="(book,index) in books" style="text-align: center;" :key="index">
                                ...
                                <td class="text-center">
                                  <button v-if="book.status" type="button" class="btn bg-black btn-xs"
                                            @click="setStatus(index,false)">Close</button>     <%-- 当前的状态为开启点击后设置为关闭--%>
                                            @click="setStatus(true)">Close</button>
                                    <button v-else type="button" class="btn bg-olive btn-xs"
                                            @click="setStatus(index,true)">Open</button>
                                    ...
                                    <button type="button" class="btn bg-red btn-xs"
                                            @click="deleteBookOne(index,book.bid,book.bname)" data-target="#modifyBook">Delete</button>
                                </td>
                            </tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">EditTheBook</h3>
                    </div>
                        ...
                        <div class="tab-pane" id="tab-common">
                            <form id="modifyBookForm">
                                <div v-if="totalOnly"  class="row data-type">
                                    ...
                                    <div class="col-md-4 title">TotalQuantity</div>
                                    ...
                                    <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                        <button type="button" @click="modifyBookTotal"
                                                class="btn bg-maroon">ConfirmModification</button>
                                ...
                                <div v-else class="row data-type">
                                    <input type="hidden" name="bid" :value="books[modifyBookIndex].bid">
                                    <div class="col-md-2 title">BookNumber</div>
                                    ...
                                    <div class="col-md-2 title">TotalQuantity</div>
                                    <div class="col-md-4 data">
                                    ...
                                    <div class="col-md-2 title">Rent</div>
                                    <div class="col-md-4 data">
                                    ...
                                    <div class="col-md-2 title">OverdueRent</div>
                                    <div class="col-md-4 data">
                                    ...
                                    <div class="col-md-2 title">Publisher</div>
                                    <div class="col-md-4 data">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">AddBook</h3>
                    </div>
                        ...
                        <div class="tab-pane" id="tab-common">
                            <form id="addBookForm">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-2 title">Rent</div>
                                    <div class="col-md-4 data">
                                        <input type="number" required min="0" class="form-control" placeholder="天/元" name="rentalUnit" value="1">
                                    </div>
                                    <div class="col-md-2 title">OverdueRent</div>
                                    <div class="col-md-4 data">
                                    ...
                                    <div class="col-md-4 data">
                                        <input type="text" required class="form-control" placeholder="出版社" name="location">
                                    </div>
                                    <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                        <button type="button" @click="addBookByForm" class="btn bg-maroon">ConfirmAddition</button>
