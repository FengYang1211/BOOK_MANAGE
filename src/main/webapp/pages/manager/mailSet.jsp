   ...
   <!-- 内容区域 -->
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                LendingInformationManagement
                <small>MailboxSettings</small>
            </h1>
            <ol class="breadcrumb">
                <li><a>LendingManagement </a></li>
                <li><a href="<%=basePath%>pages/manager/borrowBooks.jsp">LendingInformationManagement</a></li>
                <li onclick="location.reload()">MailboxSettings</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
            ...
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <ul class="nav nav-tabs ">
                        <li class="active">
                            <a href="#tab-editer" data-toggle="tab" @click="firstActive">MailTemplates</a>
                        </li>
                        <li>
                            <a href="#tab-common" data-show="true" data-toggle="tab" @click="firstActive">ModifyDefaultTemplate</a>
                        </li>
                    </ul>
                    <!--tab头/-->
                            ...
                            <div>
                                ...
                                <div class="maileditor">
                                    <div class="mailModelmenu col-md-2">
                                        <ul>
                                            <li @click="showNoDueMailModel(true)" class="mailModelmenuCurrent">NotOverdue</li>
                                            <li @click="showNoDueMailModel(false)" @click.once="getOverDueTemplete">Overdue</li>
                                        </ul>
                                    </div>
                                    <!-- 未逾期 -->
                                    <div  v-cloak v-if="noDueMailModel" class="mailEditor col-md-10">
                                        <div class="header">
                                            <div class="title">NotOverdue</div>
                                        ...
                                        <div v-cloak v-if="saveBtn" class="col-md-12 data text-center saveModelBtn">
                                            <button type="button" class="btn bg-maroon" @click="save">Save</button>
                                            <button type="button" class="btn bg-default" @click="cancel">Cancel</button>
                                        </div>
                                    </div>
                                    <!-- 逾期 -->
                                    <div v-cloak v-if="!noDueMailModel" class="mailEditor col-md-10">
                        ...
                        <div class="tab-pane " id="tab-common">
                            <div>
                                ...
                                <div class="maileditor">
                                    <div class="mailModelmenu col-md-2">
                                        <ul>
                                            <li @click="noDueMailModel = true" class="mailModelmenuCurrent">NotOverdue</li>
                                            <li @click="noDueMailModel = false" @click.once="getOverDueTemplete">Overdue</li>
                                        </ul>
                                    </div>
                                    <!-- 未逾期 -->
                                    <div  v-cloak v-if="noDueMailModel" class="mailEditor col-md-10">
                                        ...
                                        <div v-cloak class="col-md-12 data text-center saveModelBtn">
                                            <button type="button" class="btn bg-maroon" @click="saveDefault(1)">Save</button>
                                        </div>
                                    </div>
                                    <!-- 逾期 -->
                                    <div  v-cloak v-if="!noDueMailModel" class="mailEditor col-md-10">
                                        ...
                                        <div v-cloak class="col-md-12 data text-center saveModelBtn">
                                            <button type="button" class="btn bg-maroon" @click="saveDefault(2)">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
