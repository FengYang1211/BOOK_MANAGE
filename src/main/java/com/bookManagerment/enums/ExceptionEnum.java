...
public enum ExceptionEnum {
    ...
    APPOINT_ACCOUNT_BALANCE_LESS(406,"抱歉，{r_name}用户，账户余额少于{balanceLess}元不能借书，请先充值!"),
    ...
    BOOK_NOT_FOUND(404,"未查询到图书信息，请添加图书！"),
