        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" v-cloak>
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="myModalLabel" style="text-align: center;">修改用户信息</h3>
                </div>
                    ...
                    <div class="tab-pane" id="tab-common">
                        <form id="modifyBookForm">
                            ...
                            <div class="row data-type">
                                <div class="col-md-4 title">用户名</div>
                                ...
                                <div class="col-md-4 title">用户昵称</div>
                                <div class="col-md-8 data">
                                ...
                                <div class="col-md-4 title">余额</div>
                                <div class="col-md-8 data">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" v-cloak>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h3 class="modal-title" id="myModalLabel" style="text-align: center;">添加用户信息</h3>
            </div>
            <div class="modal-body">
                <!--基础控件-->
                <div class="tab-pane" id="tab-common">
                    <form id="addBookTypeForm">
                        <div class="row data-type">
                            <div class="col-md-4 title">账号</div>
                            <div class="col-md-8 data">
                            ...
                            <div class="col-md-4 title">手机号码</div>
                            <div class="col-md-8 data">
