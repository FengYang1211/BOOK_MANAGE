...
<head>
    ...
    <title>UserRegistration-BookRentalSystem</title>
...
<div class="register-box" id="app">
    <div class="register-logo">
        <a href="<%=basePath%>pages/reader/index.jsp"><b>BookRentalSystemUserRegistration</b></a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <div class="has-feedback" style="text-align: center; margin: 2% 0;">
            <a href="<%=basePath%>pages/login.jsp" class="text-center">I have an account, go and log in now</a>
        </div>
    </div>
    <!-- /.form-box -->
</div>
