...
<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>Management</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>BookManagementSystem</b></span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header" data-stopPropagation = "true">
                            ...
                            <p style="color: #0d6aad">
                                <%=reader.getRName()%>
                                <small >AccountBalance <span id="accountMoney"><%=reader.getBalance()/100.0%></span>$ <a class="fa fa-refresh" onclick="refreshMoney()"></a></small>
                            </p>
                        </li>
                        <li class="user-footer">
                            <div class="pull-left" data-toggle="modal" data-target="#addBalanceModal">
                                <a href="#" class="btn btn-default btn-flat">Charge</a>
                            </div>
                            <div class="pull-right">
                                <a href="<%=basePath%>exit/reader" class="btn btn-default btn-flat">Exit</a>
                            </div>
                        </li>
                    </ul>
                </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" v-cloak>
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="myModalLabel" style="text-align: center;">AccountCharge</h3>
                </div>
                    ...
                    <div class="tab-pane" id="tab-common" id="addBalanceEl">
                        <form action="<%=basePath%>reader/balance" id="addBalanceFrom" method="post">
                            <div class="row data-type">
                                <div class="col-md-4 title">ChargeAmount</div>
                                <div class="col-md-8 data">
                                    <input type="text" required min="0" class="form-control" placeholder="$"
                                           name="money">
                                </div>
                                <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                    <button type="submit"
                                            class="btn bg-maroon">Charge</button>
