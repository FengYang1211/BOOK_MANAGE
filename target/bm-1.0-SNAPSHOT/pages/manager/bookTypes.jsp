                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr v-if="showData" v-cloak v-for="(type,index) in bookTypes" style="text-align: center;" :key="index">
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button" class="btn bg-olive btn-xs"
                                            @click="deleteBookOne(index,type.btId,type.tname)" >Delete</button>
                                </td>
                            </tr>
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" v-cloak>
                <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="myModalLabel" style="text-align: center;">ChangeCategory</h3>
                </div>
                    ...
                    <div class="tab-pane" id="tab-common">
                        <form id="modifyBookForm">
                            ...
                            <div class="row data-type">
                                <div class="col-md-4 title">CAtegoryName</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" v-cloak>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h3 class="modal-title" id="myModalLabel" style="text-align: center;">AddCategory</h3>
            </div>
            <div class="modal-body">
                <!--基础控件-->
                <div class="tab-pane" id="tab-common">
