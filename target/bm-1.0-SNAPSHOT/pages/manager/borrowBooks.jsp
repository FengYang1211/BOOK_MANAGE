            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                                    ...
                                    <div class="form-group form-inline">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modifyBook"
                                                    title="还书"><i class="fa fa-refresh"></i> Return</button>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-1">
                            <button type="reset" style="display: inline-block;"  title="搜索" class="btn btn-default" onclick="location.href='<%=basePath%>/pages/manager/mailSet.jsp'">MailboxSettings</button>
                        </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">BookNumber</th>
                                <th class="text-center">BookName</th>
                                <th class="text-center">ReaderName</th>
                                <th class="text-center">BorrowingTime</th>
                                <th class="text-center">DateThatShouldBeReturned</th>
                            ...
                            <tr  v-if="showData" v-cloak v-for="(borrowBook,index) in borrowBooks" style="text-align: center;" :key="index">
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            @click="returnBookRemind(index)" data-target="#modifyBook">ReminderToReturnBook</button>
                                </td>
                            </tr>
                ...
                <div class="box-footer">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <span v-cloak>Total {{page}} pages, total {{total}} data. per page</span>
                            <select class="form-control" v-on:change="changeSize" id="size" >
                                <option  v-if="size==5" selected value="5">5 data</option>
                                <option v-else value="5">5 data</option>

                                <option v-if="size==10" selected value="10">10 data</option>
                                <option v-else value="10">10 data</option>

                                <option v-if="size==15" selected value="15">15 data</option>
                                <option v-else value="15">15 data</option>

                                <option v-if="size==30" selected value="30">30 data</option>
                                <option v-else value="30">30 data</option>

                                <option v-if="size==40" selected value="40">40 data</option>
                                <option v-else value="40">40 data</option>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content" style="text-align: center" v-cloak>
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">SendEmailAlerts</h4>
                    </div>
                    <div class="modal-body">
<%--                        正在向"{{borrowBooks[sendMailIndex].rname}}"用户发送还书提醒{{dot}}--%>
                        <div style="letter-spacing: 2px">Sending a book return reminder {{dot}} to "{{borrowBooks[sendMailIndex].rname}}"</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">ReturnedSuccessfully</h3>
                    </div>
                    <div class="modal-body">
                        <!--基础控件-->
                        <div class="tab-pane" id="tab-common">
                            <form id="addBookForm">
                                ...
                                <div class="row data-type">
                                    <div>
                                        <div class="col-md-2 title">User</div>
                                    ...
                                    <div>
                                        <div class="col-md-2 title">IsOverdue</div>
                                        <div class="col-md-5 data">
                                    ...
                                    <div>
                                        <div class="col-md-2 title">TotalDeductionAmount</div>
                                    ...
                                    <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                        <button type="button" class="btn bg-maroon" data-dismiss="modal" @click="$('#modifyBook').modal('show');">Confirm</button>
                                        <button type="button" class="btn bg-default" onclick="alert('系统升级后方可使用！')">Print</button>
                                    </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">ReturnBook</h3>
                    </div>
                    <div  class="modal-body">
                        <!--基础控件-->
                        <div class="tab-pane" id="tab-common">
                            <form id="modifyBookForm">
                                <div  class="row data-type">
                                    <div class="col-md-4 title">BorrowOrderNumber</div>
                                    ...
                                    <div class="col-md-12 data text-center" style="margin-top: 20px;">
                                        <button type="button" @click="confirmGiveBack"
                                                class="btn bg-maroon">ConfirmReturn</button>
