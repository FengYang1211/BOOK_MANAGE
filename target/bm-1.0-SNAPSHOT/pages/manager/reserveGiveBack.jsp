...
<div class="wrapper" id='app'>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li>
                    <a onclick="location.reload()">ReturnManagement</a>
                </li>
                <li>
            </ol>
        </section>
                    ...
                    <div class="table-box">
                        ...
                        <form id="searchForm">
                            <div class="col-md-6 form-group" style="display: flex;" v-cloak>
                                ...
                                <div class="col-md-2 data" style="display: flex;">
                                    <input type="number" name="number" autocomplete="off" required class="form-control"  placeholder="ID" >
                                </div>
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="text-center">BorrowTime</th>
                                <th class="text-center">DateOfBookShouldBeReturned</th>
                                <th class="text-center">ActualReturnTime</th>
                                <th class="text-center">IsOverdue</th>
                            </tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content" v-cloak>
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel" style="text-align: center;">ReturnSuccessfully</h3>
                    </div>
